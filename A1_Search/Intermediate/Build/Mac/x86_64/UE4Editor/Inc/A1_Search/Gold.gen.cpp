...
#include "A1_Search/Public/Gold.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	A1_SEARCH_API UClass* Z_Construct_UClass_AGold();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGold_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Gold.h" },
		{ "ToolTip", "* Stores a class for adding in gold to the screen" },
	};
#endif
	...
	IMPLEMENT_CLASS(AGold, 1476619797);
	template<> A1_SEARCH_API UClass* StaticClass<AGold>()
	{
		return AGold::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AGold(Z_Construct_UClass_AGold, &AGold::StaticClass, TEXT("/Script/A1_Search"), TEXT("AGold"), false, nullptr, nullptr, nullptr);
